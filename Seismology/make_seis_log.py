...
IDs = ['KIC4260884', 'KIC10454113', 'KIC9652971', 'KIC4457331',
       'KIC4914923', 'KIC12317678', 'KIC9025370','EPIC212617037',
       'EPIC246696804','EPIC230748783','EPIC249570007','EPIC212617037',
       'EPIC236224056']

data_type = ['dat','pow','dat','dat','pow','pow','pow','pow',
             'pow','pow','pow','dat','pow']


numax1_guess = [50.41,2250,25.35,76.48,1800,1200,3000,
                1000,1000,1000,1000,1000,1000]
numax2_guess = [120,2250,40,110,1800,1200,3000,
                1000,1000,1000,1000,1000,1000]
